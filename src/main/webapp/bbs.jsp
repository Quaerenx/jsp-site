			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<%-- <td  style="text-align:center;"><%= list.get(i).getBbsTitle() %></a></td> --%>
						...
						<%-- <td  style="text-align:center;"><a href="view.jsp?bbsID=<%= list.get(i).getBbsID() "%>"><%= list.get(i).replaceAll(" ", "&nbsp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>")  %></a></td> --%> 
